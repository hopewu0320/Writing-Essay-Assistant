...
def visualize(df, text):
    ...
    ent_html=displacy.render(doc2, style="ent", options=options, manual=True, jupyter=False)
...
if submit_botton: 
    ...
    k =st.dataframe(pred2span(preds[0], tokenized_dataset[0], viz=True,contents=contents))
